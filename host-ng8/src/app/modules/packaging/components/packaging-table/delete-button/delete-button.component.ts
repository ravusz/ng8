...
export class DeleteButtonComponent {
  ...
  constructor(private confirmationService: ConfirmationService, private packagingService: PackagingService, private messageService: MessageService) { }
  ...
  onDelete() {
    this.confirmationService.confirm({
      ...
      accept: () => {
        this.packagingService.delete(this.item.id).subscribe((data) => {
